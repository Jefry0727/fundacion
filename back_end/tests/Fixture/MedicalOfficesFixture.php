...
/**
 * MedicalOfficesFixture
 *
 */
class MedicalOfficesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'fk_medical_offices_centers1_idx' => ['type' => 'index', 'columns' => ['centers_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_medical_offices_centers1' => ['type' => 'foreign', 'columns' => ['centers_id'], 'references' => ['centers', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'created' => '2016-07-27 15:32:45',
            'modified' => '2016-07-27 15:32:45',
            'state' => 1,
            'centers_id' => 1
        ],
    ];
