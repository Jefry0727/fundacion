...
class RatesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'require_authorization' => ['type' => 'integer', 'length' => 1, 'unsigned' => false, 'null' => false, 'default' => '0', 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        '_constraints' => [
    ...
    public $records = [
        [
            ...
            'created' => '2016-11-11 10:15:03',
            'modified' => '2016-11-11 10:15:03',
            'state' => 1,
            'code' => 'Lorem ip',
