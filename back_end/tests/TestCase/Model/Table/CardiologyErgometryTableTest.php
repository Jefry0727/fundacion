...
use App\Model\Table\CardiologyErgometryTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\CardiologyErgometryTable Test Case
 */
class CardiologyErgometryTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\CardiologyErgometryTable
     */
    public $CardiologyErgometry;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('CardiologyErgometry') ? [] : ['className' => 'App\Model\Table\CardiologyErgometryTable'];
        $this->CardiologyErgometry = TableRegistry::get('CardiologyErgometry', $config);
    }
    ...
    {
        unset($this->CardiologyErgometry);
