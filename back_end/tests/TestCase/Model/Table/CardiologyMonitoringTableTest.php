...
use App\Model\Table\CardiologyMonitoringTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\CardiologyMonitoringTable Test Case
 */
class CardiologyMonitoringTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\CardiologyMonitoringTable
     */
    public $CardiologyMonitoring;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('CardiologyMonitoring') ? [] : ['className' => 'App\Model\Table\CardiologyMonitoringTable'];
        $this->CardiologyMonitoring = TableRegistry::get('CardiologyMonitoring', $config);
    }
    ...
    {
        unset($this->CardiologyMonitoring);
