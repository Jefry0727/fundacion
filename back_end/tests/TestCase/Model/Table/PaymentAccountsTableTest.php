...
use App\Model\Table\PaymentAccountsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\PaymentAccountsTable Test Case
 */
class PaymentAccountsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\PaymentAccountsTable
     */
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('PaymentAccounts') ? [] : ['className' => 'App\Model\Table\PaymentAccountsTable'];
        $this->PaymentAccounts = TableRegistry::get('PaymentAccounts', $config);
    }
