...
use App\Model\Table\ControlFormatsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\ControlFormatsTable Test Case
 */
class ControlFormatsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\ControlFormatsTable
     */
    public $ControlFormats;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('ControlFormats') ? [] : ['className' => 'App\Model\Table\ControlFormatsTable'];
        $this->ControlFormats = TableRegistry::get('ControlFormats', $config);
    }
