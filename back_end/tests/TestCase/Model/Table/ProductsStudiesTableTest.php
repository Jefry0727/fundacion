...
use App\Model\Table\ProductsStudiesTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\ProductsStudiesTable Test Case
 */
class ProductsStudiesTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\ProductsStudiesTable
     */
    public $ProductsStudies;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('ProductsStudies') ? [] : ['className' => 'App\Model\Table\ProductsStudiesTable'];
        $this->ProductsStudies = TableRegistry::get('ProductsStudies', $config);
    }
