...
use App\Model\Table\TacsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\TacsTable Test Case
 */
class TacsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\TacsTable
     */
    public $Tacs;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('Tacs') ? [] : ['className' => 'App\Model\Table\TacsTable'];
        $this->Tacs = TableRegistry::get('Tacs', $config);
    }
