...
use App\Model\Table\CancelBillsTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\CancelBillsTable Test Case
 */
class CancelBillsTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\CancelBillsTable
     */
    public $CancelBills;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('CancelBills') ? [] : ['className' => 'App\Model\Table\CancelBillsTable'];
        $this->CancelBills = TableRegistry::get('CancelBills', $config);
    }
