...
use App\Model\Table\NuclearTable;
use Cake\ORM\TableRegistry;
use Cake\TestSuite\TestCase;

/**
 * App\Model\Table\NuclearTable Test Case
 */
class NuclearTableTest extends TestCase
{

    /**
     * Test subject
     *
     * @var \App\Model\Table\NuclearTable
     */
    public $Nuclear;
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('Nuclear') ? [] : ['className' => 'App\Model\Table\NuclearTable'];
        $this->Nuclear = TableRegistry::get('Nuclear', $config);
    }
