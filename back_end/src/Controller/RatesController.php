...
{   
    ...
    public function initialize()
    {
        ...
        parent::initialize();
        $this->Auth->allow(['token','getSelectedRate']);
    }
    ...
    public function add()
    {
        ...
        $clients = $this->Rates->Clients->find('list', ['limit' => 200]);
        $this->set(compact('rate', 'clients'));
        $this->set('_serialize', ['rate']);
    }
    ...
    public function delete($id = null)
    {
        ...
        $rate = $this->Rates->find('all' , ['conditions'=>['Rates.id' => $data['id']]])->first();
